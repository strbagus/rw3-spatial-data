...
<template>
  <div class="min-h-screen bg-base-200 text-base-content flex flex-col justify-between selection:bg-primary selection:text-primary-content">
    ...
    <header class="border-b border-base-300/60 bg-base-100/70 backdrop-blur-md sticky top-0 z-50">
      <div class="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        <div class="flex items-center gap-3">
          <div class="w-9 h-9 rounded-xl bg-primary text-primary-content flex items-center justify-center font-bold text-sm shadow-md">
            RW3
          </div>
          <div>
    ...
    <main class="flex-1 max-w-6xl mx-auto px-4 sm:px-6 py-10 sm:py-14 flex flex-col justify-center">
      ...
      <div class="text-center max-w-3xl mx-auto space-y-5">
        <div class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-base-100 border border-base-300 shadow-sm text-xs font-semibold text-primary">
        ...
        <p class="text-base sm:text-lg text-base-content/75 max-w-2xl mx-auto leading-relaxed">
          Portal informasi geospasial terintegrasi untuk wilayah RW 03 Kampung Timuran, Kota Yogyakarta. Menyajikan pemetaan batas wilayah RT, persebaran jaringan kamera CCTV lingkungan, serta informasi lokasi dan kontak pengurus warga.
        </p>

        <!-- CTA Buttons -->
        <div class="pt-2 flex flex-wrap items-center justify-center gap-3">
          <NuxtLink to="/map" class="btn btn-primary btn-md sm:btn-lg gap-2 shadow-lg shadow-primary/20 hover:scale-[1.02] transition-transform">
      ...
      <div class="grid grid-cols-3 gap-3 sm:gap-6 my-10 sm:my-12 max-w-3xl mx-auto w-full">
        <div class="card bg-base-100 border border-base-300/70 shadow-sm p-4 text-center">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
        <!-- Wilayah Card -->
        <div class="card bg-base-100 border border-base-300/70 shadow-sm hover:shadow-md transition-all hover:-translate-y-1">
          <div class="card-body p-6">
            ...
            <p class="text-xs sm:text-sm text-base-content/70 leading-relaxed">
              Pemetaan polygon digital cakupan wilayah RT 07, RT 08, dan RT 09 di lingkungan RW 03 secara presisi untuk mempermudah penataan administratif.
            </p>
          </div>
        </div>
        ...
        <div class="card bg-base-100 border border-base-300/70 shadow-sm hover:shadow-md transition-all hover:-translate-y-1">
          <div class="card-body p-6">
            ...
            <p class="text-xs sm:text-sm text-base-content/70 leading-relaxed">
              Direktori titik domisili Ketua RW dan RT beserta masa periode bakti dan akses komunikasi langsung ke nomor kontak WhatsApp pengurus.
            </p>
          </div>
        </div>
      </div>
